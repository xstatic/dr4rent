...
them. This module does not provide any external impact but defining 2 new entity
types and a callback function for converting values from one unit into another.
Probably you will install this module only if another one depends on it.
